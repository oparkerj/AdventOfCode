...
public class Day22 : Puzzle
{
    ...
    public static Region Read(string line)
    {
    ...
    // Get the number of squares that a region contributes to the "final" result.
    // The contribution to the final result is how many units are not overridden by a future
    // instruction.
