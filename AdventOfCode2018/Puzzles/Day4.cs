...
namespace AdventOfCode2018.Puzzles
{
    public class Day4 : Puzzle
    {
        ...
        public override void PartOne()
        {
            ...
            var (guard, minutes) = schedule.SelectMaxBy(pair => pair.Value.Values.Sum());
            var minute = minutes.SelectMaxBy(pair => pair.Value).Key;
        ...
        public override void PartTwo()
        {
            ...
            var (guard, minutes) = schedule.SelectMaxBy(pair => pair.Value.Values.DefaultIfEmpty().Max());
            var minute = minutes.SelectMaxBy(pair => pair.Value).Key;
            WriteLn(guard * minute);
        }
